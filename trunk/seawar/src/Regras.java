...
public class Regras {
	public void validarPosicaoNavio(Embarcacao objEmbarcacao,
			Tabuleiro objTabuleiro) {

	}

	public boolean validarTiro(Celula objCelula, Tabuleiro objTabuleiro) {

		// TODO: Retratar a assinatura do método abaixo, deve retornar apenas um
		// array unitario (normal)
