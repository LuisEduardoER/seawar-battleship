...
public class Principal extends JApplet {
	...
	private String nomeJogadores[] = { "Débora", "Fernando", "Reginaldo",
			"Reinaldo", "Marcus", "Vitor", "______________________________" };
	...
	private void verificaLogin() {
		...
		if (u.isUsuarioAtivo() == true) {
			...
			tema.play();
			/*
			 * textUsuario.setEnabled(false); senha.setEnabled(false);
			 * entrar.setEnabled(false); cancelar.setEnabled(false);
			 */
		}
